...
typedef struct {
    bool valid;         // true if this line is valid
    bool dirty;         // true if this line is dirty
    uword_t block_addr; // the block address of this line
    byte_t *data; // pointer to the buffer containing the data for this line
} evicted_line_t;
